document.addEventListener('DOMContentLoaded', () => {
    ...
    function finishAssessment() {
        // Temporarily store the responses and log them to the console
        console.log("Assessment Finished. User Responses:", userAnswers);
        
        // You can later send this data to a server or display results
        alert("Thank you for completing the assessment! Your results have been recorded.");
    ...
    // --- EVENT LISTENERS ---
    startJourneyBtn.addEventListener('click', startAssessment);
    navTakeSurvey.addEventListener('click', (e) => {
        e.preventDefault();
        startAssessment();
    });
